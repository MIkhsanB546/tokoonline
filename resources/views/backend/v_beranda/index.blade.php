            ...
            <div class="card">
                <div class="card-body border-top">
                    ...
                    <div class="alert alert-success" role="alert">
                        <h4 class="alert-heading"> Selamat Datang, {{ Auth::user()->nama ?? 'unknown' }}</h4> Aplikasi Toko
                        Online dengan hak akses yang anda miliki sebagai <b>
                            @if (Auth::user()->role == 1)
                                Super Admin
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="card-body">
                            ...
                            excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denimaesthetic
